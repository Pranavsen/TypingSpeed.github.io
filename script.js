...
// This will generate Ramdom paragraphs*******************************************
function randomPara() {
...
// This work when we click Start Button****************************
const start = () => {
    let date = new Date();
...
// This work when we  click Done Button****************************
const end = () => {
    // Time Generate***********************************************(1)
    let date = new Date();
    endTime = date.getTime();
    let totalTime = ((endTime - startTime) / 1000);
    timeTag.innerText = totalTime;

    // Words per Second Generate************************************(2)
    ...
    // Mistakes Generate********************************************(3)
    let mist = compareWords(typingText.innerText, totalstr);
